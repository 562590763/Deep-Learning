...
from model.TransUNet.networks import vit_seg_configs as configs
from model.TransUNet.networks.vit_seg_modeling_resnet_skip import ResNetV2
    ...
    def load_from(self, weights):
        with torch.no_grad():
            ...
            if posemb.size() == posemb_new.size():
                ...
                posemb_grid = posemb_grid.reshape(1, gs_new * gs_new)
                posemb = posemb_grid
