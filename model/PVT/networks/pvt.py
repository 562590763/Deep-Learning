...
@register
def pvt_tiny(args, **kwargs):
    model = PVT(
        patch_size=args.patch_size, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8],
...
@register
def pvt_huge_v2(args, **kwargs):
    model = PVT(
        patch_size=args.patch_size, embed_dims=[128, 256, 512, 768], num_heads=[2, 4, 8, 12],
        mlp_ratios=[8, 8, 4, 4], qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6),
