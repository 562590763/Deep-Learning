...
from model.PoolFormer.networks.poolformer import PatchEmbed, LayerNormChannel, GroupNorm, Mlp
...
__all__ = [
    'metaformer_id_s12', 'metaformer_pppa_s12_224', 'metaformer_ppaa_s12_224',
    'metaformer_pppf_s12_224', 'metaformer_ppff_s12_224'
]
...
@register
def metaformer_id_s12(args, **kwargs):
    layers = [2, 2, 6, 2]
...
@register
def metaformer_pppa_s12_224(args, **kwargs):
    layers = [2, 2, 6, 2]
    embed_dims = [64, 128, 320, 512]
...
@register
def metaformer_ppaa_s12_224(args, **kwargs):
    layers = [2, 2, 6, 2]
    embed_dims = [64, 128, 320, 512]
...
@register
def metaformer_pppf_s12_224(args, **kwargs):
    layers = [2, 2, 6, 2]
    embed_dims = [64, 128, 320, 512]
...
@register
def metaformer_ppff_s12_224(args, **kwargs):
    layers = [2, 2, 6, 2]
    embed_dims = [64, 128, 320, 512]
